            ...
            {isLoading ? (
                ...
                <div className="flex h-full flex-col space-y-4 overflow-y-auto font-mallanna">
                    <div className="mb-4 flex-shrink-0 text-center">
                        ...
                        {/* <p className="text-xs text-gray-600">Welcome to Xplora, your personal career discovery guide. Get ready to explore!!!</p> */}
                    ...
                    {/* <div className="mt-4 flex-shrink-0 rounded-lg bg-gray-50 p-3 font-mallanna">
                    ...
                    <p className="text-xs text-gray-600">
                        You’ve completed all the tests. Click on 'Get Career Results' to see the careers that match your personality, skills, and
                        interests.
                    </p>
