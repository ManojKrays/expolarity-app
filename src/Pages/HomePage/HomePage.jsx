...
const HomePage = () => {
  ...
  <div className="flex flex-col items-center justify-center h-screen text-center px-4">
    <motion.h2
      ...
      className="text-5xl md:text-4xl sm:text-3xl font-bold text-gray-900"
    >
    ...
    <motion.p
      ...
      className="text-gray-700 mt-2 text-lg sm:text-base"
    >
  ...
  {/* Bottom Sections */}
  <div className="absolute bottom-0 w-full grid grid-cols-2 md:grid-cols-4 text-center text-white bg-teal-500">
    <div className="py-4 border-b md:border-b-0 border-teal-600">PRODUCTS</div>
    <div className="py-4 border-b md:border-b-0 border-teal-600">SCHOOLS</div>
    <div className="py-4">PARTNERS</div>
    ...
    <div
  className="flex flex-col items-center justify-center text-center p-10 pb-60  bg-center bg-no-repeat bg-auto mx-auto"
...
>
  ...
  <p className="text-[16px] text-gray-600 p-4 w-[40%]">
  ...
  {/* Text Section */}
  <div className="w-full md:w-[30%] absolute top-10 left-0 md:left-10 lg:left-60 text-center md:text-left">
    <p className="text-[28px] md:text-[32px]">a breakdown of strengths and areas for improvement</p>
  </div>
  ...
  <div className="flex flex-col md:flex-row items-center justify-center gap-10 md:gap-20 mt-40 md:mt-20">
    ...
    <div className="flex flex-col gap-5 md:gap-10 w-full md:w-auto">
      ...
      <section className="flex flex-wrap items-center px-20 py-20 ">
        ...
        >
          <div className="flex items-center">
            ...
            <h2 className="text-4xl font-bold text-teal-600">SCHOOLS</h2>
          </div>
          <p className="text-gray-700 mt-2 md:w-2/3">
            Many schools across the world use Expolarity.ai to transform the way
            they record and analyse data. Do you want to know how?
          </p>
          <motion.button
  ...
  >
    ...
    <span className="text-md ">3,68,641</span>
        ...
        >
          <h3 className="text-teal-600 text-3xl font-bold">
            WHAT OUR CUSTOMERS HAVE TO SAY
          </h3>
          <p className="italic text-gray-700 mt-2 w-[60%]">
            "On behalf of all the members of the Heritage Family, I wanted to
            congratulate Expolarity.ai on such a different and amazing website. We
            would like to convey our best regards to your team..."
          </p>
      ...
      <section className="flex items-center justify-start p-8 px-20">
        <div className="max-w-lg">
          <div className="flex items-center gap-2">
            <FaUsers className="text-teal-700 text-3xl" />
            <h2 className="text-3xl font-bold text-teal-700">PARTNERS</h2>
          </div>
          <p className="text-gray-700 mt-4">
            Expolarity.ai's deep focus on data and open architecture enables many
            organisations working in the education sector to integrate with the
            Expolarity.ai's application. Do you want to leverage the data analytics
            and reporting capabilities of Expolarity.ai?
          </p>
          <button className="mt-6 px-6 py-2 border border-teal-600 text-teal-600 rounded-md hover:bg-teal-600 hover:text-white transition">
            LEARN MORE...
          </button>
        </div>
      </section>
  ...
  <div className="w-full md:w-2/3">
    <h2 className="text-2xl sm:text-3xl font-bold text-teal-700 flex items-center gap-2">
      <FaSatelliteDish className="text-3xl sm:text-4xl" /> CONNECT WITH US
    </h2>
    ...
    <p className="mt-4 text-lg sm:text-xl font-semibold">Please reach us at</p>
  ...
  <div className="w-full md:w-1/3 flex flex-col gap-4 sm:gap-6 mt-8 md:mt-0">
    <div>
      <h3 className="text-base sm:text-lg font-bold text-teal-700">OFFICE</h3>
      <p className="text-gray-700 text-sm sm:text-base">
        123, abc Street, abc City, 999999, India.
      </p>
      <p className="text-gray-700 text-sm sm:text-base">Ph: +99 9999 999 999</p>
...
const Card = ({ title, description, image }) => {
  return (
    <div className="bg-white shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] rounded-lg w-80 flex flex-col items-center">
    <img src={image} alt={title} className="w-40 h-40" />
    <div className="p-10">
      <h3 className="text-lg font-semibold">{title}</h3>
      <p className="text-gray-500 text-sm pt-2 pb-6">{description}</p>
